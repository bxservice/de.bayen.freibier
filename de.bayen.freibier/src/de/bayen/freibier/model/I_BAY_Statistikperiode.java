...
/** Generated Interface for BAY_Statistikperiode
 *  @author iDempiere (generated) 
 *  @version Release 2.0
 */
@SuppressWarnings("all")
public interface I_BAY_Statistikperiode 
{

    /** TableName=BAY_Statistikperiode */
    public static final String Table_Name = "BAY_Statistikperiode";
    ...
    /** Column name BAY_Statistikperiode_UU */
    public static final String COLUMNNAME_BAY_Statistikperiode_UU = "BAY_Statistikperiode_UU";
    ...
    /** Column name createNGVExport */
    public static final String COLUMNNAME_createNGVExport = "createNGVExport";
    ...
    /** Column name erzeugeMeldungen */
    public static final String COLUMNNAME_erzeugeMeldungen = "erzeugeMeldungen";
    ...
    /** Column name Statistiktyp */
    public static final String COLUMNNAME_Statistiktyp = "Statistiktyp";
