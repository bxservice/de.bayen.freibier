...
//
//import de.bayen.freibier.model.X_I_BPartnerDurst;
//
///**
...
// */
//public class ImportBPartnerDurst extends SvrProcess
...
//
//		//	Go through Records
//		sql = new StringBuffer ("SELECT * FROM "+getImportTableName()+" "
//				+ "WHERE I_IsImported='N'").append(clientCheck);
//		// gody: 20070113 - Order so the same values are consecutive.
//		sql.append(" ORDER BY Value, "+getImportTableName()+"_ID");
...
//
//				X_I_BPartnerDurst impBP = new X_I_BPartnerDurst(getCtx(), rs, get_TrxName());
//				log.fine(""+getImportTableName()+"_ID=" + impBP.get_ID()
...
//							.append("WHERE "+getImportTableName()+"_ID=").append(impBP.get_ID());
...
//						// -TB-
//						bp.setIsActive(impBP.isUnlocked());
//						ModelValidationEngine.get().fireImportValidate(this, impBP, bp, ImportValidator.TIMING_AFTER_IMPORT);
//						
//						setTypeOfBPartner(impBP,bp);
//						
...
//		{
//			rollback();
//			log.log(Level.WARNING, "Exception in BusinessPartner Import", e);
...
//
//
//	private MBPartner createMBPartner(X_I_BPartnerDurst impBP) {
//		MBPartner bp;
//		bp = new MBPartner(impBP.getCtx(), 0, impBP.get_TrxName());
//		bp.setClientOrg(impBP.getAD_Client_ID(),impBP.getAD_Org_ID());
//		//bp.setUpdatedBy(impBP.getUpdatedBy());
//		//
...
//		// -TB-
//		/* 
//		 * Ich importiere nicht mehr aktive Datensätze, 
//		 * um diese für Statistiken noch nutzen zu können.
//		 */
//		bp.setIsActive(impBP.isUnlocked());
//		return bp;
//	}
...
//	{
//		return X_I_BPartnerDurst.Table_Name;
//	}
//	
//	/**
...
//	 * @param MBPartner bp
//	 */
//	private void setTypeOfBPartner(X_I_BPartnerDurst impBP, MBPartner bp){
//		if (impBP.isVendor()){		
//			bp.setIsVendor(true);
